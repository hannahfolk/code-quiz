...
var questions = [
    ...
    {
        title: "What is the name of the Central Perk barista who has a crush on Rachel?",
        choices: ["James", "Arnold", "Donald", "Gunther"],
        answer: "Gunther"
    },
    {
        title: "What is the name that appears on the address label of Chandler's TV guide?",
        choices: ["Ms. Chanandler Bong", "Chanandler Bong", "Chandler Bing", "Chandler Bong"],
        answer: "Ms. Chanandler Bong"
    },
    {
        title: "In what season is \"The One With the Prom Video\", where Rachel and Ross finally get together?",
        choices: ["3", "6", "2", "10"],
        answer: "2"
    }
];
...
submitBtn.addEventListener("click", function(event) {
    ...
    if (formInput.value !== "null" && formInput.value !== "" && (formInput.value.length == 2 || formInput.value.length ==3)) {
        loadNextPage();
